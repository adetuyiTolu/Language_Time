...
public class Igbo implements Time{
   ...
   @Override
    ...
    String getMinute(int minute){
        ...
        if(minute>30){
            description=Constants.BEFORE_POINTER +getNumber(60-minute)+Constants.BEFORE_POINTER2;
        }else if(minute<=30){
            description=Constants.AFTER_POINTER +getNumber(minute)+Constants.AFTER_POINTER2;
        }
        return description;
    }
