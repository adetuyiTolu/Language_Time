...
package com.crevation.nglocaltime.english;
...
public class English implements Time {
    ...
    private String getTimeHour(int hour, int minute) {
        ...
        if (minute > 30) {
         ...
         if (minute == 0) return yor_hour + Constants.OCLOCK;
        else return yor_minute + " " + yor_hour;
    }
    ...
    private String getMinute(int minute) {
        ...
        String description = Constants.number30.trim() +Constants.AFTER_POINTER;
